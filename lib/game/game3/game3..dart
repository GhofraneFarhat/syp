...
import '../../Play.dart';
import '../game3/pause3/settings.dart';
import '../lvl.dart';
import 'lvl3.dart';
import '../game3/pause3/menu.dart';
...
late Stopwatch stopwatch3;
late Timer _timer;

class Game3_1 extends StatefulWidget {
  @override
  _Game3_1State createState() => _Game3_1State();
}

class _Game3_1State extends State<Game3_1> {
  //stopwatch
        ...
        body: Stack(
          children: [
            ...
            Align(
                ...
                child: Text(
                  formatTime(stopwatch3.elapsedMilliseconds),
